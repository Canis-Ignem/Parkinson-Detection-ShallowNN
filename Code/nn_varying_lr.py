...
import featureExtraction_var_lr as fe
...
test_control = fe.getControlFeaturesTest()
test_park = fe.getParkinsonFeaturesTest()
...
targetTest = fe.getClasses(test_control,test_park)
